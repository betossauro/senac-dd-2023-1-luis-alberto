...
public class ExecutavelTelefonia {
	...
	public static void main(String[] args) {
		...
		Cliente pele = new Cliente("Edson Arantes", "11122233344", true, null, endereco1);
		Cliente socrates = new Cliente("Sócrates Brasileiro", "33322233344", true, telefonesDoSocrates, endereco1);
